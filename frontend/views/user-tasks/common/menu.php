...
<section class="menu-toggle">
    <ul class="menu-toggle__list">
        <li class="menu-toggle__item <?= $active == "Завершённые" ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--completed">
            ...
            <a href="<?= Url::to(["/user-tasks/completed"]) ?>">
                Завершённые
            </a>
        </li>
        <li class="menu-toggle__item <?= $active == "Новые" ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--new">
            <div class="menu-toggle__svg-wrapper">
        ...
        <li class="menu-toggle__item <?= $active == "Активные" ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--active">
            <div class="menu-toggle__svg-wrapper">
            ...
            <a href="<?= Url::to(["/user-tasks/active"]) ?>">
                Активные
            </a>
        </li>
        <li class="menu-toggle__item  <?= $active == "Отменённые" ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--canceled">
            <div class="menu-toggle__svg-wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <a href="<?= Url::to(["/user-tasks/failed"]) ?>">
                Отменённые
            </a>
        </li>
        <li class="menu-toggle__item  <?= $active == "Просроченные" ? 'menu_toggle__item--current' : '' ?> menu-toggle__item--hidden">
            <div class="menu-toggle__svg-wrapper">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
